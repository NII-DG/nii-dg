...
from nii_dg.utils import (DG_CONFIG, HERE, download_schema,
                          import_custom_class, import_external_class,
                          parse_ctx)
        ...
        for entity in jsonld["@graph"]:
            ...
            if id_ == "./" and type_ == "Dataset":
                ...
                if DG_CONFIG["DG_USE_EXTERNAL_CTX"]:
                    ...
                    entity_class = import_external_class(HERE.joinpath(f"{DOWNLOADED_SCHEMA_DIR_NAME}/{gh_repo}/{gh_ref}/{schema}.py").resolve(), type_)
                else:
