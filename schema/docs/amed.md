...
| `accessRightsInfo` | `str` | Required when accessRights has `Unshared` or `Restricted Closed Sharing` and availabilityStarts property is not included in this entity. | Reason of keep unshared or closed sharing status. | `Because the dataset contains personal information.` |
